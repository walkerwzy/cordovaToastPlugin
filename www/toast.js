...
var exec = require("cordova/exec");
module.exports = {
	longshow : function(msg,successCallback,failureCallback){
		cordova.exec(successCallback,failureCallback,'ToastPlugin',[{message:msg,duration:1}]);
	},
	shortshow : function(msg,successCallback,failureCallback){
		cordova.exec(successCallback,failureCallback,'ToastPlugin',[{message:msg,duration:0}]);
	}
};